...
Related specifications: `docs/artifex/10A-asset-library.md`, `docs/artifex/8A-archetype-object-creator.md`, `docs/artifex/9A-effect-editor.md`, `docs/artifex/11A-shared-connected-project-folder-service.md`  
...
All current and future Registered Content Service / Picker work belongs in `docs/artifex/2A-global-to-do.md`. This specification must not become a task list.
