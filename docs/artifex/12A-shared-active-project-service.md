...
Related service specification: `docs/artifex/11A-shared-connected-project-folder-service.md`  
...
`artifex/shared/todo-guide/all-apps-todos.json` contains current outstanding platform work for active-project runtime integration. That work belongs in `2A`, not in this specification.
...
All current and future implementation work belongs in `docs/artifex/2A-global-to-do.md`. This specification must not become a task list.
