...
Related specifications: `11A-connected-project-folder.md`, `12A-active-project.md`, `13A-registered-content-picker.md`  
...
Project-specific task files describe missing/broken content inside one connected project. They are not the same as `docs/artifex/02A-global-to-do.md`, which is the human-readable Artifex platform backlog.
...
All current and future Shared Health Guide / Project Audit work belongs in `docs/artifex/02A-global-to-do.md`. This specification must not become a task list.
