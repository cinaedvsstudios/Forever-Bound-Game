...
Active specification file: `docs/artifex/18A-sound-generator-sound-library.md`  
...
Related specifications: `docs/artifex/10A-asset-library.md`, `docs/artifex/11A-shared-connected-project-folder-service.md`, `docs/artifex/13A-registered-content-service-picker.md`  
...
All current and future Sound Generator / Sound Library work belongs in `docs/artifex/2A-global-to-do.md`. This specification must not become a task list.
