...
Related specifications: `docs/artifex/14A-health-guide.md`, `docs/artifex/15A-build-game.md`  
...
All current and future Runtime Engine / Playtest work belongs in `docs/artifex/02A-global-to-do.md`. This specification must not become a task list.
