...
const STRUCTURED_PRESETS = [
  {
    ...
    config: {
      ...
      rimAmount: 42, rimOpacity: 42, rimThickness: 24, rimRadius: 82, rimSoftness: 34, rimSpeed: 8,
      innerWispAmount: 7, innerWispOpacity: 32, innerWispThickness: 2.5, innerWispGlow: 14, innerWispSpeed: 18, innerWispCurl: 48, innerWispVerticalSpread: 54,
      innerWispColorA: '#6cfaff', innerWispColorB: '#9b62ff', innerWispLayerPosition: 'rim-front',
      outlineThickness: 2.5, outlineOpacity: 78, outlineGlow: 24, outlineRadius: 86, outlinePulseStrength: 8, outlinePulseSpeed: 12,
      outlineColorMode: 'animated', outlineColorA: '#eaffff', outlineColorB: '#7ae8ff', outlineLayerPosition: 'front',
      cloudAmount: 24, cloudOpacity: 24, cloudSize: 14, orbitRadius: 100, cloudStagger: 42, cloudPulseStrength: 14, cloudOrbitSpeed: 9,
      particleAmount: 32, particleOpacity: 28, particleSpeed: 18, particleSpread: 68, particleSize: 3, particleGlow: 12, particlePulseStrength: 10
    }
  },
  {
    ...
    config: {
      ...
      armAmount: 28, armOpacity: 16, armThickness: 28, armRadius: 58, armSoftness: 34, armDefinition: 48, armPulseStrength: 10, armRotationSpeed: 8, armCurlTurns: 62,
      cloudAmount: 18, cloudOpacity: 14, cloudSize: 12, orbitRadius: 64, cloudStagger: 42, cloudPulseStrength: 8, cloudOrbitSpeed: 7,
      particleAmount: 24, particleOpacity: 28, particleSpeed: 16, particleSpread: 46, particleSize: 2.6, particleGlow: 12, particlePulseStrength: 8,
      emissionAmount: 0, emissionOpacity: 0, emissionSpeed: 18, emissionDirection: 0, emissionVacuum: true, emissionTrailLength: 30, emissionTrailOpacity: 28
    }
  }
];
