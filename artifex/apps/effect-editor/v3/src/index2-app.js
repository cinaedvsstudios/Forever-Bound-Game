import './prototype-adapters/shimmer-control-range-boosts.js?v=051-wormhole-visible-range';
import { initEditorCore } from './editor-core.js?v=051-wormhole-visible-range';
...
const VERSION_LABEL = 'INDEX2-WORMHOLE-VISIBLE-RANGE-0.2.29';
