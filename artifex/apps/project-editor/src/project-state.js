import { createDefaultProjectState, cloneDefaultData } from './data/project-defaults.js?v=0.1.8-hotfix3';
import { listCatalogItems } from './data/flatplan-catalog.js?v=0.1.8-hotfix3';
