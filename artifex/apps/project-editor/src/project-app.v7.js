import { renderProjectShell } from './project-shell.js?v=0.1.31-tasks';
import { PROJECT_THEME, applyProjectTheme, getProjectThemeTailwindConfig } from './project-theme.js?v=0.1.31-tasks';
import { createProjectEditorStateManager } from './project-state.js?v=0.1.31-tasks';
...
import { enhanceProjectIO } from './project-io.js?v=0.1.31-tasks';
...
applyProjectTheme();
renderProjectShell({ version: 'v0.1.31 TASKS' });
...
function init() {
  ...
  refresh();
  console.info('[Artifex Project Editor] v0.1.31 TASKS loaded', {
