// Maze / Labyrinth difficulty report
//
// Stable replacement for the former V1.12 modal patch.
// Owns the branded Artifex report modal and the current difficulty analysis report.
