// Obstacle Course / Horse Forest Runner V29
...
const TEMPLATES = {
  horse_forest_easy: { label: 'Horse Forest Ride', obstacleRate: 1 },
  ...
  OC.stage.innerHTML = `
    <div class="obstacle-workspace">
      <section class="obstacle-view-card">
        <div class="obstacle-header-line"><div><p class="eyebrow">Obstacle Course · Horse Forest Runner V29</p><h2 id="obstacle-title">Horse Forest Ride</h2><p id="obstacle-objective">Transparent modular WEBP path segments over forest_floor_grass2.</p></div><span id="obstacle-status" class="obstacle-status-pill">Ready</span></div>
...
function downloadJson() {
  ...
  a.download = `horse-forest-course-settings-${new Date().toISOString().replace(/[:.]/g, '-')}.json`;
