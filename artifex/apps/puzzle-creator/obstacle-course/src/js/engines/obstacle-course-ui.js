...
export function updateDocumentVersion() {
  ...
  document.querySelectorAll('.version-pill,.status-pill').forEach((node) => { if (/V\d/.test(node.textContent || '')) node.textContent = VERSION; });
}
