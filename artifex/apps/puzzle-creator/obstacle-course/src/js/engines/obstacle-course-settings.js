...
export const DEFAULT_SETTINGS = {
  ...
  cameraAngle: 0,
  backgroundZoom: 1.1,
  visual: { brightness: 0.93, contrast: 1.17, saturation: 1.15, tint: '#000000', tintStrength: 0.06 },
  pathSegments: Array.from({ length: 321 }, (_, index) => ({ id: '1', distance: index * 80 })),
  layers: {
    ground: { visible: true, opacity: 1, x: 0, y: 2.9, z: 0, scale: 0.24950000000000006, order: 1, brightness: 0.58, contrast: 1.18, saturation: 0.84, tint: '#ffffff', tintStrength: 0 },
    ...
    trees: { visible: true, opacity: 1, x: 0, y: 1.5999999999999996, z: 0, scale: 4, order: 20, brightness: 0.62, contrast: 1.21, saturation: 0.7488, tint: '#ffffff', tintStrength: 0 },
    ...
    obstacles: { visible: true, opacity: 1, x: 0, y: 0.8999999999999997, z: 0, scale: 1, order: 16, brightness: 1, contrast: 1, saturation: 1, tint: '#ffffff', tintStrength: 0 },
    collectibles: { visible: true, opacity: 1, x: 0, y: -2.3000000000000003, z: 0, scale: 1, order: 15, brightness: 1, contrast: 1, saturation: 1, tint: '#ffffff', tintStrength: 0 },
  },
  glbControls: {
