// Obstacle Course V3.03 state and constants
export const VERSION = 'V3.03';
export const CACHE_VERSION = '3.03';
...
export const OC = {
  ...
  player: { x: 0, y: 0, vy: 0, grounded: true, jumpHoldTime: 0, maxJumpHoldTime: 0.24, jumpWasDown: false, duck: false },
