...
export const GLB_ASSETS = [
  ...
  { url: `${ASSET_BASE}3d/pine_with_awkward_teenage_face.glb`, label: 'Pine with Awkward Teenage Face', type: 'nearTree', scale: 1, targetHeight: 10.8, optional: true },
  { url: `${ASSET_BASE}3d/small_pine.glb`, label: 'Small Pine', type: 'nearTree', scale: 1, targetHeight: 8.8, optional: true },
  { url: `${ASSET_BASE}3d/spruce_tree.glb`, label: 'Spruce Tree', type: 'nearTree', scale: 1, targetHeight: 12.8, optional: true },
  { url: `${ASSET_BASE}3d/tree_low-poly.glb`, label: 'Tree Low Poly', type: 'nearTree', scale: 1, targetHeight: 12.0, optional: true },
  { url: `${ASSET_BASE}3d/dead_tree.glb`, label: 'Dead Tree', type: 'nearTree', scale: 1, targetHeight: 10.5, optional: true },
  ...
  { url: `${ASSET_BASE}3d/tree_gn.glb`, label: 'Tree GN', type: 'farTree', scale: 1, targetHeight: 13.5, optional: true },
  ...
  { url: `${ASSET_BASE}3d/grass_patches.glb`, label: 'Grass Patches', type: 'groundGrass', scale: 1, targetHeight: 0.62, optional: true },
