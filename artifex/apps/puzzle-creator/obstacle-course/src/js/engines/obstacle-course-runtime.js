// Obstacle Course V3.0.19 / Modular Horse Forest Runner
...
import { buildGroundAndPath, clearWorld, playerWorldX } from './obstacle-course-ground-path.js?v=3.0.19';
import { scatterScenery } from './obstacle-course-scenery.js?v=3.0.19';
import { addCollectibles } from './obstacle-course-collectibles.js';
import { addObstacles } from './obstacle-course-obstacles.js';
import { updateMovement, resetRun } from './obstacle-course-movement.js?v=3.0.19';
...
import { scheduleOverviewDraw, drawOverview } from './obstacle-course-overview.js?v=3.0.19';
...
import { bindObstacleCourseControls, setInteractionLocked } from './obstacle-course-controls.js?v=3.0.19';
...
function ensureMounted() {
  ...
  loadRequiredAssets({ onFirstReady: () => { applyBackgroundPlate(); showSpinner(true); updateHorseSprite(); renderOnce(); } }).then(() => {
    ...
    import('./obstacle-course-asset-debug.js?v=3.0.19').catch(() => {});
