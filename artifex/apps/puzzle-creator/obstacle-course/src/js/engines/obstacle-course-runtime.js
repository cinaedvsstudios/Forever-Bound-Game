...
import { ensureHeader, injectStyles, mountLayout, mountLeftPanel, enhanceStaticRangeSteppers, setResult } from './obstacle-course-ui.js?v=3.0.27';
import { applyDefaultSettings } from './obstacle-course-settings.js?v=3.0.27';
import { exportJsonSettings, importJsonSettings } from './obstacle-course-export-import.js?v=3.0.27';
import { initScene, renderOnce, applyBackgroundPlate, updateWorldTransform } from './obstacle-course-scene.js?v=3.0.27';
import { loadRequiredAssets, loadOptionalAssets } from './obstacle-course-loader.js?v=3.0.27';
import { bindKeyboard } from './obstacle-course-input.js?v=3.0.27';
...
import { addCollectibles } from './obstacle-course-collectibles.js?v=3.0.27';
import { addObstacles } from './obstacle-course-obstacles.js?v=3.0.27';
import { updateMovement, resetRun } from './obstacle-course-movement.js?v=3.0.27';
import { updateHud, showSpinner } from './obstacle-course-hud.js?v=3.0.27';
import { updateHorseSprite } from './obstacle-course-horse.js?v=3.0.27';
import { applyAllLayers } from './obstacle-course-layers.js?v=3.0.27';
...
import { loadGlbAsset, applyAllGlbAssetControls } from './obstacle-course-glb.js?v=3.0.27';
...
import { installButtonFeedback } from './obstacle-course-button-feedback.js?v=3.0.27';
import { installOverviewLayout } from './obstacle-course-overview-layout.js?v=3.0.27';
import { installHorseAspectFix } from './obstacle-course-horse-aspect.js?v=3.0.27';
