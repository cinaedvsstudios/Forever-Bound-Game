// Obstacle Course V3.05 / Modular Horse Forest Runner
...
import { applyDefaultSettings } from './obstacle-course-settings.js?v=3.05';
import { exportJsonSettings, importJsonSettings } from './obstacle-course-export-import.js?v=3.05';
import { initScene, renderOnce, applyBackgroundPlate, updateWorldTransform } from './obstacle-course-scene.js?v=3.05';
import { loadRequiredAssets, loadOptionalAssets } from './obstacle-course-loader.js?v=3.05';
import { bindKeyboard } from './obstacle-course-input.js';
import { buildGroundAndPath, clearWorld, playerWorldX } from './obstacle-course-ground-path.js?v=3.05';
import { scatterScenery } from './obstacle-course-scenery.js?v=3.05';
import { addCollectibles } from './obstacle-course-collectibles.js?v=3.05';
import { addObstacles } from './obstacle-course-obstacles.js?v=3.05';
import { updateMovement, resetRun } from './obstacle-course-movement.js?v=3.05';
import { updateHud, showSpinner } from './obstacle-course-hud.js';
import { updateHorseSprite } from './obstacle-course-horse.js';
import { applyAllLayers } from './obstacle-course-layers.js?v=3.05';
import { populateLayerSelect, createLayerSliders } from './obstacle-course-layer-controls.js?v=3.05';
import { scheduleOverviewDraw, drawOverview } from './obstacle-course-overview.js?v=3.05';
import { loadGlbAsset, applyAllGlbAssetControls } from './obstacle-course-glb.js?v=3.05';
import { createGlbAssetSliders } from './obstacle-course-glb-controls.js?v=3.05';
import { bindObstacleCourseControls, setInteractionLocked } from './obstacle-course-controls.js?v=3.05';
...
function ensureMounted() {
  ...
  loadRequiredAssets({ onFirstReady: () => { applyBackgroundPlate(); showSpinner(true); updateHorseSprite(); renderOnce(); } }).then(() => {
    ...
    import('./obstacle-course-asset-debug.js?v=3.05').catch(() => {});
