// Obstacle Course V3.0.14 / Modular Horse Forest Runner
...
import { scatterScenery } from './obstacle-course-scenery.js?v=3.0.14';
import { addCollectibles } from './obstacle-course-collectibles.js';
import { addObstacles } from './obstacle-course-obstacles.js';
import { updateMovement, resetRun } from './obstacle-course-movement.js';
...
import { scheduleOverviewDraw, drawOverview } from './obstacle-course-overview.js?v=3.0.14';
...
import { bindObstacleCourseControls, setInteractionLocked } from './obstacle-course-controls.js';
...
function ensureMounted() {
  ...
  loadRequiredAssets({ onFirstReady: () => { applyBackgroundPlate(); showSpinner(true); updateHorseSprite(); renderOnce(); } }).then(() => {
    ...
    import('./obstacle-course-asset-debug.js?v=3.0.14').catch(() => {});
