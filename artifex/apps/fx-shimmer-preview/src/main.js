import { SHIMMER_PRESETS, clonePreset } from './presets.js?v=1.31';
import { ShimmerDistortionEngine } from './shimmer-engine.js?v=1.31';
...
function fxAssetJson() {
  ...
  return {
    ...
    compatibilityNotes: [
      ...
      'V1.31 keeps the V1.30 asset picker and makes wormhole clouds/arms visibly respond without overlays.',
...
renderPresets();
syncControls();
setStatus('Loaded shimmer engine prototype V1.31.');
requestAnimationFrame(tick);
