...
#quickstart-dialog.wizard-dialog{width:min(97vw,1580px)!important;max-width:none!important}#quickstart-dialog .dialog-shell{width:min(97vw,1580px)!important;max-width:none!important;max-height:93vh!important}#quickstart-dialog .wizard-content{max-height:calc(93vh - 112px)!important}#quickstart-dialog .wizard-build-shell{grid-template-columns:minmax(240px,300px) minmax(780px,1fr)!important;gap:16px!important;min-height:640px!important}#quickstart-dialog .wizard-build-detail-panel{display:grid!important;grid-template-columns:minmax(360px,.95fr) minmax(430px,1.05fr)!important;align-content:start!important;column-gap:18px!important;row-gap:10px!important;overflow:visible!important}#quickstart-dialog .wizard-build-detail-panel>h3,#quickstart-dialog .wizard-build-detail-panel>p.hint{grid-column:1/-1!important}#quickstart-dialog .wizard-preview-stage{grid-column:1!important;width:100%!important;max-width:440px!important;margin:2px 0 0!important}#quickstart-dialog .wizard-preview-controls{grid-column:1!important;margin:8px 0 0!important}#quickstart-dialog .wizard-build-fields{grid-column:2!important;grid-row:3/span 2!important;grid-template-columns:repeat(2,minmax(160px,1fr))!important;margin:0!important;align-self:start!important}#quickstart-dialog .wizard-build-detail-panel>label{grid-column:2!important}#quickstart-dialog .wizard-correction-grid{grid-column:1/-1!important;grid-template-columns:repeat(4,minmax(140px,1fr))!important}#quickstart-dialog .wizard-build-actions{grid-column:1/-1!important}#quickstart-dialog .wizard-frame-strip{grid-column:1/-1!important;min-height:150px!important;width:100%!important}#quickstart-dialog .wizard-frame-box{flex-basis:112px!important;min-height:112px!important}@media(max-width:1100px){#quickstart-dialog .wizard-build-shell{grid-template-columns:1fr!important}#quickstart-dialog .wizard-build-detail-panel{grid-template-columns:1fr!important}#quickstart-dialog .wizard-build-detail-panel>*{grid-column:1!important;grid-row:auto!important}#quickstart-dialog .wizard-build-fields{grid-template-columns:1fr!important}}
`;
