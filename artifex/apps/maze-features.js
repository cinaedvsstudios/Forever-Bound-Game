export default {
  ...
  mode: 'scene_mode',
  defaultModuleId: 'ch00_optional_hazard_puzzle',
  callingText: 'Avoid, cleanse, contain, or escape the spreading hazard.',
  purpose: 'Creates a hazard challenge with pulsing danger zones, spread rules, proximity danger, cleansing interaction, survival timer, and win/loss state.',
  fields: [
    ...
    { key: 'sourceCount', label: 'Hazard Sources', type: 'range', value: 5, min: 1, max: 16, step: 1 },
  ...
  preview: { kind: 'hazard', accent: '#0b1110' }
};
